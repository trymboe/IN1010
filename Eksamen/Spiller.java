class Spiller{
    ...
    protected static VeiValgSted sted;
    protected static VeiValgSted vvsted;
    ...
    public Sted velgSted(Sted forrigeSted){
        double data = Math.random()*Terreng.stedsliste.size();
        int indeks = (int)Math.floor(data);
        return Terreng.stedsliste.get(indeks);
    }
}
